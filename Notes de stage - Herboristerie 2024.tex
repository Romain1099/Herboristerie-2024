...
\newcommand{\ficherecette}[9]{
    ...
    \begin{boiterecette}[#1]
        \begin{multicols}{2}
            \textbf{Ingrédients :}\\
            \begin{bclogo}[couleur=blue!30,arrondi=0.1,logo=\bccrayon]{Ingrédients}
                \begin{itemize}[label=\mysquare]
                    #2
                \end{itemize}
            \end{bclogo}
            \begin{bclogo}[couleur=blue!30,arrondi=0.1,logo=\bccrayon]{Matériel}
                \begin{itemize}[label=\mysquare]
                    #3
                \end{itemize}
            \end{bclogo}
        \end{multicols}
        \begin{multicols}{2}
            \begin{bclogo}[couleur=blue!30,arrondi=0.1,logo=\bccalendrier]{Conservation}
                #4
            \end{bclogo}
            \begin{bclogo}[couleur=blue!30,arrondi=0.1,logo=\bcoutil]{Utilisation}
                #5
            \end{bclogo}
